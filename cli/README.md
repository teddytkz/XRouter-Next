...
```bash
xrouter-next                    # Start with default settings
xrouter-next --port 8080        # Custom port
xrouter-next --no-browser       # Don't open browser
xrouter-next --skip-update      # Skip auto-update check
xrouter-next --help             # Show all options
```
